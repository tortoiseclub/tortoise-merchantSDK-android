...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("tortoise_merchant_apiKey", new ApiKeyAuth("header", "X-TORTOISE-KEY"));
    INSTANCE.authentications.put("tortoise_merchant_appId", new ApiKeyAuth("header", "X-TORTOISE-ID"));
